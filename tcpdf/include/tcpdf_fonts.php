...
class TCPDF_FONTS {
	...
	public static function addTTFfont($fontfile, $fonttype='', $enc='', $flags=32, $outpath='', $platid=3, $encid=1, $addcbbox=false, $link=false) {
		...
		$font_path_parts = pathinfo((string) $fontfile);
...
// ====================================================================================================================
	...
	public static function utf8Bidi($ta, &$currentfont, $str='', $forcertl=false, $isunicode=true) {
		...
		if (preg_match(TCPDF_FONT_DATA::$uni_RE_PATTERN_ARABIC, (string) $str)) {
			$arabic = true;
		} else {
			$arabic = false;
		}
		// check if string contains RTL text
		if (!($forcertl OR $arabic OR preg_match(TCPDF_FONT_DATA::$uni_RE_PATTERN_RTL, (string) $str))) {
			return $ta;
		}
