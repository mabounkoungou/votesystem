        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Candidates Management</h3>
                            ...
                            <tbody>
                                ...
                                while ($row = $query->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src='" . htmlspecialchars($image) . "' width='30' height='30' alt='Candidate Photo'>
                                        ...
                                        <td>
                                            <a href='#platform' data-toggle='modal' class='btn btn-info btn-sm btn-rounded platform' data-id='" . $row['canid'] . "'>
                                                <i class='fa fa-book'></i> View
                                            </a>
                                        </td>
                                        <td>
                                            <button class='btn btn-success btn-sm edit btn-rounded' data-id='" . $row['canid'] . "'><i class='fa fa-edit'></i> Edit</button>
                                            <button class='btn btn-danger btn-sm delete btn-rounded' data-id='" . $row['canid'] . "'><i class='fa fa-trash'></i> Delete</button>
                                        </td>
                                    </tr>
                                    ";
                                }
