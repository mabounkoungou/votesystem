    ...
    <div class="row">
        ...
        <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Voters Management</h3>
                            ...
                            <tbody>
                                ...
                                while ($row = $query->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>" . $row['firstname'] . "</td>
                                        <td>
                                            <img src='" . $image . "' width='30px' height='30px' class='rounded-circle'>
                                        ...
                                        <td>" . $row['voters_id'] . "</td>
                                        <td>
                                            <button class='btn btn-success btn-sm edit btn-rounded' data-id='" . $row['id'] . "'>
                                                <i class='fa fa-edit'></i> Edit
                                            </button>
                                            <button class='btn btn-danger btn-sm delete btn-rounded' data-id='" . $row['id'] . "'>
...
$(function() {
    ...
    $(document).on('click', '.delete', function(e) {
        ...
        $('#delete').modal('show');
        var id = $(this).data('id');
        $('.id').val(id); // Pass the id to the delete form
    });

    // Handle photo edit button click (if needed)
...
// Fetch voter details for editing
function getRow(id) {
    $.ajax({
        type: 'POST',
        url: 'voters_row.php',
